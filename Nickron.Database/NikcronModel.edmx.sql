...
CREATE TABLE [dbo].[ProductModels] (
    ...
    [OSVersion] nvarchar(250)  NULL,
    [InternalStorage] nvarchar(250)  NULL,
    [ExternalStorage] nvarchar(250)  NULL,
    [DisplayType] nvarchar(250)  NULL,
    [DisplaySize] nvarchar(250)  NULL,
    [DisplayResolution] nvarchar(250)  NULL,
    [Dimension] nvarchar(250)  NULL,
    [Weight] nvarchar(250)  NULL,
    [BatteryType] nvarchar(250)  NULL,
    [BatteryStandBy] float  NULL,
    [PrimaryCamera] nvarchar(250)  NULL,
    [SecondryCamera] nvarchar(250)  NULL,
    [VideoRecording] nvarchar(250)  NULL,
...
CREATE TABLE [dbo].[ProductModels_Mobile] (
    ...
    [CallFeatures] nvarchar(250)  NULL,
    [SimSize] nvarchar(250)  NULL,
    [SimType] nvarchar(250)  NULL,
    [CallMemory] nvarchar(250)  NULL,
    [PhoneMemory] nvarchar(250)  NULL,
    [SMSMemory] nvarchar(250)  NULL,
    [PreinstalledBrowser] nvarchar(250)  NULL,
    [MusicPlayer] nvarchar(250)  NULL,
    [VideoPlayer] nvarchar(250)  NULL,
    [FM] nvarchar(250)  NULL,
    [SoundEnhancement] nvarchar(250)  NULL,
    [RingTone] nvarchar(250)  NULL,
    [SARValue] nvarchar(250)  NULL,
    [InternetFeatures] nvarchar(250)  NULL,
    [Connectivity_HSPA_3G] nvarchar(250)  NULL,
    [Connectivity_GPRS_2G] nvarchar(250)  NULL,
    [Connectivity_USB] nvarchar(250)  NULL,
    [Connectivity_Bluetooth] nvarchar(250)  NULL,
    [Connectivity_Hotspot] nvarchar(250)  NULL,
    [Connectivity_SupportedNetworks] nvarchar(250)  NULL,
    [Connectivity_OperatingFrequencies] nvarchar(250)  NULL,
    [Connectivity_EDGE_2G] nvarchar(250)  NULL,
    [Id] int  NOT NULL
);
GO
...
CREATE TABLE [dbo].[ProductModels_Tablet] (
    [CallFeatures] nvarchar(250)  NULL,
    [SupportedNetworks] nvarchar(250)  NULL,
    [PreinstalledBrowser] nvarchar(250)  NULL,
    [InternetFeatures] nvarchar(250)  NULL,
    [AudioJack] nvarchar(250)  NULL,
    [AudioFormat] nvarchar(250)  NULL,
    [VideoFormat] nvarchar(250)  NULL,
    [Connectivity_HSPA_3G] nvarchar(250)  NULL,
    [Connectivity_GPRS_2G] nvarchar(250)  NULL,
    [Connectivity_USB] nvarchar(250)  NULL,
    [Connectivity_Bluetooth] nvarchar(250)  NULL,
...
CREATE TABLE [dbo].[ProductModels_Laptop] (
    [Chipset] nvarchar(250)  NULL,
    [ClockSpeed] nvarchar(250)  NULL,
    [Cache] nvarchar(250)  NULL,
    [HardwareInterface] nvarchar(250)  NULL,
    [RPM] nvarchar(250)  NULL,
    [HDDCapacity] nvarchar(250)  NULL,
    [OpticalDrive] nvarchar(250)  NULL,
    [SystemArch] nvarchar(250)  NULL,
    [GraphicProcessor] nvarchar(250)  NULL,
    [Keyboard] nvarchar(250)  NULL,
    [Speakers] nvarchar(250)  NULL,
    [Sound] nvarchar(250)  NULL,
    [BatteryCell] nvarchar(250)  NULL,
    [USBPort] nvarchar(250)  NULL,
    [VGAPort] nvarchar(250)  NULL,
    [HDMIPort] nvarchar(250)  NULL,
    [RJ45LAN] nvarchar(250)  NULL,
    [MultiCardSlot] nvarchar(250)  NULL,
    [MemorySlots] nvarchar(250)  NULL,
    [Id] int  NOT NULL
);
GO
